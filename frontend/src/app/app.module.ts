...
import { BaseDashboardMenuCardComponent } from './common/dashboard-cards/base-dashboard-menu-card/base-dashboard-menu-card.component';
...
@NgModule({
  declarations: [
    ...
    BillCardComponent,
    MenuCardsComponent,
    BaseDashboardMenuCardComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
